...
/**
 * Capability definitions for the advwork module
 *
 * @package    mod_advwork
...
$capabilities = array(
    ...
    // Ability to see that the advwork exists, and the basic information
    // about it, for example the intro field
    'mod/advwork:view' => array(
        'captype' => 'read',
    ...
    // Ability to add a new advwork to the course.
    'mod/advwork:addinstance' => array(
    ...
    // Ability to change the current phase (stage) of the advwork, for example
    // allow submitting, start assessment period, close advwork etc.
    'mod/advwork:switchphase' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/advwork:editdimensions' => array(
    ...
    // in the advwork as the authors
    'mod/advwork:submit' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'student' => CAP_ALLOW,
    ...
    'mod/advwork:manageexamples' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    // Ability to publish submissions, i.e. make them available when advwork is closed
    'mod/advwork:publishsubmissions' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/advwork:viewauthornames' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'student' => CAP_ALLOW,
    ...
    'mod/advwork:viewreviewernames' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/advwork:viewallsubmissions' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    // Ability to view published submission when the advwork is closed. Group mode
    // restrictions do not apply here, published submissions are available in all
    // groups even in the separate groups mode.
    'mod/advwork:viewpublishedsubmissions' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'student' => CAP_ALLOW,
    ...
    'mod/advwork:viewauthorpublished' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'student' => CAP_ALLOW,
    ...
    'mod/advwork:viewallassessments' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/advwork:overridegrades' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/advwork:ignoredeadlines' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/advwork:deletesubmissions' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/advwork:exportsubmissions' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'manager' => CAP_ALLOW,
