 ...
 * strictness factor. It adds its XML data to advwork tag.
 */
class backup_advworkeval_best_subplugin extends backup_subplugin {

    /**
     * Returns the subplugin information to attach to advwork element
     */
    protected function define_advwork_subplugin_structure() {
        ...
        $subplugin_table_settings = new backup_nested_element('advworkeval_best_settings', null, array('comparison'));
        ...
        $subplugin_table_settings->set_source_table('advworkeval_best_settings', array('advworkid' => backup::VAR_ACTIVITYID));
