...
require_once($CFG->dirroot . '/mod/advwork/eval/best/lib.php');
require_once($CFG->libdir . '/gradelib.php');


class advworkeval_best_evaluation_testcase extends advanced_testcase {

    /** advwork instance emulation */
    protected $advwork;
    ...
    protected function setUp() {
        ...
        $advwork = $this->getDataGenerator()->create_module('advwork', array('evaluation' => 'best', 'course' => $course));
        $cm = get_fast_modinfo($course)->instances['advwork'][$advwork->id];
        $this->advwork = new advwork($advwork, $cm, $course);
        $this->evaluator = new testable_advwork_best_evaluation($this->advwork);
    }
    ...
    public function test_assessments_distance_zero_variance() {
        ...
        // Simulate structure returned by {@link advwork_best_evaluation::prepare_data_from_recordset()}
        $assessments = array(
        ...
        // Process assessments in the same way as in the {@link advwork_best_evaluation::process_assessments()}
 ...
 */
class testable_advwork_best_evaluation extends advwork_best_evaluation {
