 ...
 * advwork_assessments table.
 */
interface advwork_allocator {
     ...
     *
     * @param stdClass $wsoutput advwork module renderer can be used
 ...
 */
class advwork_allocation_result implements renderable {
    ...
    /** @var advwork_allocator the instance of the allocator that produced this result */
    protected $allocator;
     ...
     *
     * @param advwork_allocator $allocator
     */
    public function __construct(advwork_allocator $allocator) {
