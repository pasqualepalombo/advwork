...
require_once($CFG->dirroot . '/mod/advwork/allocation/random/lib.php');


class advworkallocation_random_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        $this->allocator = new testable_advwork_random_allocator($this->advwork);
    }
 ...
 */
class testable_advwork_random_allocator extends advwork_random_allocator {
