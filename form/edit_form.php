 ...
 * @uses moodleform
 */
class advwork_edit_strategy_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform = $this->_form;
        $this->advwork = $this->_customdata['advwork'];
        $this->strategy = $this->_customdata['strategy'];

        $mform->addElement('hidden', 'advworkid', $this->advwork->id);        // advworkid
        $mform->setType('advworkid', PARAM_INT);

        $mform->addElement('hidden', 'strategy', $this->advwork->strategy);    // strategy name
        ...
        $buttonarray[] = $mform->createElement('submit', 'saveandpreview', get_string('saveandpreview', 'advwork'));
