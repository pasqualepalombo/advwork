 ...
 * needed to restore one advworkform_comments subplugin.
 */
class restore_advworkform_comments_subplugin extends restore_subplugin {
    ...
    protected function define_advwork_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/advworkform_comments_dimension'); // we used get_recommended_name() so this works
    ...
    protected function define_referenceassessment_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/advworkform_comments_referencegrade'); // we used get_recommended_name() so this works
        $paths[] = new restore_path_element($elename, $elepath);
    ...
    protected function define_exampleassessment_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/advworkform_comments_examplegrade'); // we used get_recommended_name() so this works
        $paths[] = new restore_path_element($elename, $elepath);
    ...
    protected function define_assessment_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/advworkform_comments_grade'); // we used get_recommended_name() so this works
        $paths[] = new restore_path_element($elename, $elepath);
    ...
    /**
     * Processes the advworkform_comments_dimension element
     */
    public function process_advworkform_comments_dimension($data) {
        global $DB;
        ...
        $newitemid = $DB->insert_record('advworkform_comments', $data);
        $this->set_mapping($this->get_namefor('dimension'), $oldid, $newitemid, true);

        // Process files for this advworkform_comments->id only
        $this->add_related_files('advworkform_comments', 'description', $this->get_namefor('dimension'), null, $oldid);
    }

    /**
     * Processes the advworkform_comments_referencegrade element
     */
    public function process_advworkform_comments_referencegrade($data) {
        $this->process_dimension_grades_structure('advwork_referenceassessment', $data);
    }

    /**
     * Processes the advworkform_comments_examplegrade element
     */
    public function process_advworkform_comments_examplegrade($data) {
        $this->process_dimension_grades_structure('advwork_exampleassessment', $data);
    }

    /**
     * Processes the advworkform_comments_grade element
     */
    public function process_advworkform_comments_grade($data) {
