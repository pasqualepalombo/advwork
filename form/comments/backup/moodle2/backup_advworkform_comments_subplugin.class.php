 ...
 */
class backup_advworkform_comments_subplugin extends backup_subplugin {
    ...
    protected function define_advwork_subplugin_structure() {
        ...
        $subplugindimension = new backup_nested_element('advworkform_comments_dimension', array('id'), array(
        ...
        $subplugindimension->set_source_table('advworkform_comments', array('advworkid' => backup::VAR_ACTIVITYID));

        // file annotations
        $subplugindimension->annotate_files('advworkform_comments', 'description', 'id');
    ...
    protected function define_referenceassessment_subplugin_structure() {
        return $this->dimension_grades_structure('advworkform_comments_referencegrade');
    }
    ...
    protected function define_exampleassessment_subplugin_structure() {
        return $this->dimension_grades_structure('advworkform_comments_examplegrade');
    }
    ...
    protected function define_assessment_subplugin_structure() {
        return $this->dimension_grades_structure('advworkform_comments_grade');
    }
