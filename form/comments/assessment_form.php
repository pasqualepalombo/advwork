 ...
 * @uses moodleform
 */
class advwork_comments_assessment_form extends advwork_assessment_form {
    ...
    protected function definition_inner(&$mform) {
        ...
        for ($i = 0; $i < $nodims; $i++) {
            // dimension header
            $dimtitle = get_string('dimensionnumber', 'advworkform_comments', $i+1);
            ...
            // comment
            $label = get_string('dimensioncommentfor', 'advworkform_comments', $dimtitle);
