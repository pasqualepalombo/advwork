...
interface advwork_strategy {
     ...
     * are saved in advworkform_{strategyname} tables.
     *
     ...
     * If advworkid is null, it checks for any advwork instance. If advworkid is provided,
