...
/**
 * Unit tests for acc_mod grading strategy logic
 *
...
require_once($CFG->dirroot . '/mod/advwork/form/acc_mod/lib.php');


class advwork_acc_mod_strategy_testcase extends advanced_testcase {
    /** advwork instance emulation */
    protected $advwork;

    /** @var testable_advwork_acc_mod_strategy instance of the strategy logic class being tested */
    protected $strategy;
    ...
    protected function setUp() {
        ...
        $advwork = $this->getDataGenerator()->create_module('advwork', array('strategy' => 'acc_mod', 'course' => $course));
        $cm = get_fast_modinfo($course)->instances['advwork'][$advwork->id];
        $this->advwork = new advwork($advwork, $cm, $course);
        $this->strategy = new testable_advwork_acc_mod_strategy($this->advwork);
    }
 ...
 */
class testable_advwork_acc_mod_strategy extends advwork_acc_mod_strategy {
