 ...
 * needed to restore one advworkform_accumulative subplugin.
 */
class restore_advworkform_accumulative_subplugin extends restore_subplugin {
    ...
    protected function define_advwork_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/advworkform_accumulative_dimension'); // we used get_recommended_name() so this works
    ...
    protected function define_referenceassessment_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/advworkform_accumulative_referencegrade'); // we used get_recommended_name() so this works
        $paths[] = new restore_path_element($elename, $elepath);
    ...
    protected function define_exampleassessment_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/advworkform_accumulative_examplegrade'); // we used get_recommended_name() so this works
        $paths[] = new restore_path_element($elename, $elepath);
    ...
    protected function define_assessment_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/advworkform_accumulative_grade'); // we used get_recommended_name() so this works
        $paths[] = new restore_path_element($elename, $elepath);
    ...
    /**
     * Processes the advworkform_accumulative_dimension element
     */
    public function process_advworkform_accumulative_dimension($data) {
        global $DB;
        ...
        $newitemid = $DB->insert_record('advworkform_accumulative', $data);
        $this->set_mapping($this->get_namefor('dimension'), $oldid, $newitemid, true);

        // Process files for this advworkform_accumulative->id only
        $this->add_related_files('advworkform_accumulative', 'description', $this->get_namefor('dimension'), null, $oldid);
    }

    /**
     * Processes the advworkform_accumulative_referencegrade element
     */
    public function process_advworkform_accumulative_referencegrade($data) {
        $this->process_dimension_grades_structure('advwork_referenceassessment', $data);
    }

    /**
     * Processes the advworkform_accumulative_examplegrade element
     */
    public function process_advworkform_accumulative_examplegrade($data) {
        $this->process_dimension_grades_structure('advwork_exampleassessment', $data);
    }

    /**
     * Processes the advworkform_accumulative_grade element
     */
    public function process_advworkform_accumulative_grade($data) {
