 ...
 */
class backup_advworkform_accumulative_subplugin extends backup_subplugin {
    ...
    protected function define_advwork_subplugin_structure() {
        ...
        $subplugindimension = new backup_nested_element('advworkform_accumulative_dimension', array('id'), array(
        ...
        $subplugindimension->set_source_table('advworkform_accumulative', array('advworkid' => backup::VAR_ACTIVITYID));

        // id annotations
        $subplugindimension->annotate_ids('scale', 'grade');

        // file annotations
        $subplugindimension->annotate_files('advworkform_accumulative', 'description', 'id');
    ...
    protected function define_referenceassessment_subplugin_structure() {
        return $this->dimension_grades_structure('advworkform_accumulative_referencegrade');
    }
    ...
    protected function define_exampleassessment_subplugin_structure() {
        return $this->dimension_grades_structure('advworkform_accumulative_examplegrade');
    }
    ...
    protected function define_assessment_subplugin_structure() {
        return $this->dimension_grades_structure('advworkform_accumulative_grade');
    }
