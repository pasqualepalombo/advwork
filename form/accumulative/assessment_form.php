 ...
 * @uses moodleform
 */
class advwork_accumulative_assessment_form extends advwork_assessment_form {
    ...
    protected function definition_inner(&$mform) {
        ...
        for ($i = 0; $i < $nodims; $i++) {
            // dimension header
            $dimtitle = get_string('dimensionnumber', 'advworkform_accumulative', $i+1);
            ...
            $label = get_string('dimensiongradefor', 'advworkform_accumulative', $dimtitle);
            ...
            $mform->addRule(array('grade__idx_' . $i, 'minusone') , get_string('mustchoosegrade', 'advworkform_accumulative'), 'compare', 'gt');

            // comment
            $label = get_string('dimensioncommentfor', 'advworkform_accumulative', $dimtitle);
