 ...
 */
class backup_advworkform_numerrors_subplugin extends backup_subplugin {
    ...
    protected function define_advwork_subplugin_structure() {
        ...
        $subpluginmap = new backup_nested_element('advworkform_numerrors_map', array('id'), array(
            'nonegative', 'grade'));
        $subplugindimension = new backup_nested_element('advworkform_numerrors_dimension', array('id'), array(
        ...
        $subpluginmap->set_source_table('advworkform_numerrors_map', array('advworkid' => backup::VAR_ACTIVITYID));
        $subplugindimension->set_source_table('advworkform_numerrors', array('advworkid' => backup::VAR_ACTIVITYID));

        // file annotations
        $subplugindimension->annotate_files('advworkform_numerrors', 'description', 'id');
    ...
    protected function define_referenceassessment_subplugin_structure() {
        return $this->dimension_grades_structure('advworkform_numerrors_referencegrade');
    }
    ...
    protected function define_exampleassessment_subplugin_structure() {
        return $this->dimension_grades_structure('advworkform_numerrors_examplegrade');
    }
    ...
    protected function define_assessment_subplugin_structure() {
        return $this->dimension_grades_structure('advworkform_numerrors_grade');
    }
