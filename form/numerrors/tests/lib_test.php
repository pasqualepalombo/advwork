...
require_once($CFG->dirroot . '/mod/advwork/form/numerrors/lib.php');


class advworkform_numerrors_strategy_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        $advwork = $this->getDataGenerator()->create_module('advwork', array('strategy' => 'numerrors', 'course' => $course));
        $cm = get_fast_modinfo($course)->instances['advwork'][$advwork->id];
        $this->advwork = new advwork($advwork, $cm, $course);
        $this->strategy = new testable_advwork_numerrors_strategy($this->advwork);
    }
 ...
 */
class testable_advwork_numerrors_strategy extends advwork_numerrors_strategy {
