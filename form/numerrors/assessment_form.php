 ...
 * @uses moodleform
 */
class advwork_numerrors_assessment_form extends advwork_assessment_form {
    ...
    protected function definition_inner(&$mform) {
        ...
        for ($i = 0; $i < $nodims; $i++) {
            // dimension header
            $dimtitle = get_string('dimensionnumber', 'advworkform_numerrors', $i+1);
            ...
            $label = get_string('dimensiongrade', 'advworkform_numerrors');
            ...
            ), 'group_grade__idx_' . $i, get_string('yourassessmentfor', 'advwork', $dimtitle), '<br />', false);
            $mform->addRule('group_grade__idx_' . $i, get_string('required'), 'required');

            // comment
            $label = get_string('dimensioncommentfor', 'advworkform_numerrors', $dimtitle);
