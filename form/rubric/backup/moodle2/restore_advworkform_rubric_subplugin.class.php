 ...
 * needed to restore one advworkform_rubric subplugin.
 */
class restore_advworkform_rubric_subplugin extends restore_subplugin {
    ...
    protected function define_advwork_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/advworkform_rubric_config');
        $paths[] = new restore_path_element($elename, $elepath);

        $elename = $this->get_namefor('dimension');
        $elepath = $this->get_pathfor('/advworkform_rubric_dimension');
        $paths[] = new restore_path_element($elename, $elepath);

        $elename = $this->get_namefor('level');
        $elepath = $this->get_pathfor('/advworkform_rubric_dimension/advworkform_rubric_level');
        $paths[] = new restore_path_element($elename, $elepath);
    ...
    protected function define_referenceassessment_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/advworkform_rubric_referencegrade'); // we used get_recommended_name() so this works
        $paths[] = new restore_path_element($elename, $elepath);
    ...
    protected function define_exampleassessment_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/advworkform_rubric_examplegrade'); // we used get_recommended_name() so this works
        $paths[] = new restore_path_element($elename, $elepath);
    ...
    protected function define_assessment_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/advworkform_rubric_grade'); // we used get_recommended_name() so this works
        $paths[] = new restore_path_element($elename, $elepath);
    ...
    /**
     * Processes the advworkform_rubric_map element
     */
    public function process_advworkform_rubric_config($data) {
        global $DB;

        $data = (object)$data;
        $data->advworkid = $this->get_new_parentid('advwork');
        $DB->insert_record('advworkform_rubric_config', $data);
    }

    /**
     * Processes the advworkform_rubric_dimension element
     */
    public function process_advworkform_rubric_dimension($data) {
        global $DB;
        ...
        $newitemid = $DB->insert_record('advworkform_rubric', $data);
        $this->set_mapping($this->get_namefor('dimension'), $oldid, $newitemid, true);

        // Process files for this advworkform_rubric->id only
        $this->add_related_files('advworkform_rubric', 'description', $this->get_namefor('dimension'), null, $oldid);
    }

    /**
     * Processes the advworkform_rubric_level element
     */
    public function process_advworkform_rubric_level($data) {
        global $DB;

        $data = (object)$data;
        $data->dimensionid = $this->get_new_parentid($this->get_namefor('dimension'));
        $DB->insert_record('advworkform_rubric_levels', $data);
    }

    /**
     * Processes the advworkform_rubric_referencegrade element
     */
    public function process_advworkform_rubric_referencegrade($data) {
        $this->process_dimension_grades_structure('advwork_referenceassessment', $data);
    }

    /**
     * Processes the advworkform_rubric_examplegrade element
     */
    public function process_advworkform_rubric_examplegrade($data) {
        $this->process_dimension_grades_structure('advwork_exampleassessment', $data);
    }

    /**
     * Processes the advworkform_rubric_grade element
     */
    public function process_advworkform_rubric_grade($data) {
