...
require_once($CFG->dirroot . '/mod/advwork/form/rubric/lib.php');


class advworkform_rubric_strategy_test extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        $advwork = $this->getDataGenerator()->create_module('advwork', array('strategy' => 'rubric', 'course' => $course));
        $cm = get_fast_modinfo($course)->instances['advwork'][$advwork->id];
        $this->advwork = new advwork($advwork, $cm, $course);
        $this->strategy = new testable_advwork_rubric_strategy($this->advwork);
 ...
 */
class testable_advwork_rubric_strategy extends advwork_rubric_strategy {
