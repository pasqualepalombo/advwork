@mod @mod_advwork @javascript @_file_upload
Feature: Teachers can embed images into instructions and conclusion fields
  In order to display images as a part of instructions or conclusions in the advwork
  As a teacher
  ...
  Scenario: Embedding the image into the instructions and conclusions fields
    ...
    And I upload "mod/advwork/tests/fixtures/moodlelogo.png" file to "Files" filemanager
    And I click on "Save changes" "button"
    And I am on "Course 1" course homepage with editing mode on
    # Create and edit the advwork.
    When I add a "advwork" to section "1" and I fill the form with:
      | advwork name | advwork with embedded images  |
    And I follow "advwork with embedded images"
    ...
    And I change phase in advwork "advwork with embedded images" to "Submission phase"
    Then "//*[contains(@class, 'instructions')]//img[contains(@src, 'pluginfile.php') and contains(@src, '/mod_advwork/instructauthors/moodlelogo.png') and @alt='How to submit']" "xpath_element" should exist
    And I change phase in advwork "advwork with embedded images" to "Assessment phase"
    And "//*[contains(@class, 'instructions')]//img[contains(@src, 'pluginfile.php') and contains(@src, '/mod_advwork/instructreviewers/moodlelogo.png') and @alt='How to assess']" "xpath_element" should exist
    And I change phase in advwork "advwork with embedded images" to "Closed"
    And "//*[contains(@class, 'conclusion')]//img[contains(@src, 'pluginfile.php') and contains(@src, '/mod_advwork/conclusion/moodlelogo.png') and @alt='Well done']" "xpath_element" should exist
