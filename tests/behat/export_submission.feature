@mod @mod_advwork
Feature: Exporting advwork submissions and assessments to a portfolio
  In order to archive my advwork contribution in a personal storage
  As a student or as a teacher
  I need to be able to export a advwork submission and its associated assessments
  ...
  Background:
    ...
    And I should see "advwork submissions report"
