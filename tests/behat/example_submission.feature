@mod @mod_advwork @_file_upload
Feature: Provide example submission
  In order to let students practise the assessment process in the advwork
  As a teacher
  I need to be able to define example submission and its referential assessment

  @javascript
  Scenario: Add example submission with attachments to a advwork
    # Prepare the users, course, enrolments and the advwork instance.
    ...
    And the following "activities" exist:
      ...
      | advwork | Testadvwork | Test advwork description | c1     | advwork1 | 1           |
    # As a teacher, define the assessment form to be used in the advwork.
