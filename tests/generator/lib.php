...
/**
 * mod_advwork data generator class.
 *
 * @package    mod_advwork
 * @category   test
 * @copyright  2013 Marina Glancy
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_advwork_generator extends testing_module_generator {
    ...
    public function create_instance($record = null, array $options = null) {
        ...
        // Add default values for advwork.
        $record = (array)$record + array(
            'strategy' => $advworkconfig->strategy,
            'grade' => $advworkconfig->grade,
            'gradinggrade' => $advworkconfig->gradinggrade,
            'gradedecimals' => $advworkconfig->gradedecimals,
            'nattachments' => 1,
            'submissionfiletypes' => null,
            'maxbytes' => $advworkconfig->maxbytes,
            'latesubmissions' => 0,
            'useselfassessment' => 0,
            'overallfeedbackmode' => 1,
            'overallfeedbackfiles' => 0,
            'overallfeedbackfiletypes' => null,
            'overallfeedbackmaxbytes' => $advworkconfig->maxbytes,
            'useexamples' => 0,
            'examplesmode' => $advworkconfig->examplesmode,
            'submissionstart' => 0,
            'submissionend' => 0,
     ...
     */
    public function create_submission($advworkid, $authorid, $options = null) {
        global $DB;
        ...
        $id = $DB->insert_record('advwork_submissions', $record);
    ...
    public function create_assessment($submissionid, $reviewerid, $options = null) {
        ...
        $id = $DB->insert_record('advwork_assessments', $record);
