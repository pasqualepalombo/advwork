...
/**
 * The mod_advwork assessment_evaluations reset event.
 *
 * @package    mod_advwork
 * @category   event
...
/**
 * The mod_advwork assessment_evaluations reset event class.
 *
...
class assessment_evaluations_reset extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has reset the assessment evaluations for the advwork with course module id " .
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'advwork', 'update clear aggregated grade', 'view.php?id=' . $this->contextinstanceid,
    ...
    public static function get_name() {
        return get_string('eventassessmentevaluationsreset', 'mod_advwork');
    }
