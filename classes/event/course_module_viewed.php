...
/**
 * The mod_advwork course module viewed event.
 *
 * @package    mod_advwork
...
/**
 * The mod_advwork course module viewed event class.
 *
 * @package    mod_advwork
 * @since      Moodle 2.6
...
class course_module_viewed extends \core\event\course_module_viewed {
    ...
    protected function get_legacy_eventdata() {
        ...
        $advwork = $this->get_record_snapshot('advwork', $this->objectid);
        ...
        return (object)array('advwork' => $advwork, 'user' => $USER);
    }
