...
class actionbar implements renderable, templatable {
     ...
     * @param \advwork $advwork The advwork object.
     */
    public function __construct(moodle_url $currenturl, \advwork $advwork) {
    ...
    public function export_for_template(renderer_base $output): array {
        ...
        foreach (array_keys($allocators) as $methodid) {
            $selectorname = get_string('pluginname', 'advworkallocation_' . $methodid);
            $menu[$this->advwork->allocation_url($methodid)->out(false)] = $selectorname;
        }
